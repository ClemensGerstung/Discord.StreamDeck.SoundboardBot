    ...
    websocket.onmessage = function (evt) {
        ...
        switch (jsonObj.event) {
            ...
            case 'propertyInspectorDidAppear':
				...
				soundfile.value = customSettings[uuid];
                break;
            default:
                break;
        }
...
function refreshSettings(settings) {
    ...
    // if (settings && settings.soundfileValue) {
        // soundfile.value = settings.soundfileValue;
    // }
...
function updateSettings() {
    ...
    setSettings.payload = {};
    setSettings.payload.soundfile = soundfile.value;

    websocket.send(JSON.stringify(setSettings));
	
	customSettings[uuid] = soundfile.value;
}
